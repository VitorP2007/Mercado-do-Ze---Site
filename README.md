...
Este projeto tem caráter **acadêmico**, sendo utilizado como atividade prática para demonstrar a aplicação dos seguintes conceitos de **Interface Humano-Máquina**:
